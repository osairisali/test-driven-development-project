...
describe('unliking a movie', () => {
  ...
  it('should display unlike widget when the movie has been liked', async () => {
    // we still need to provide movie id as initiator of likeButton,
    // even we provide it in beforeEach function
    // that is why we need to check our code doesn't dupclitaing
    // the stored movie with same id in likeMovieSpec.js
